...
OUTPUT_TABLE_SPECS = {
    "learning_costs.csv": [
        ...
        "postsolve_battery_pack_learning_cost_eur_per_kwh",
        "postsolve_battery_energy_bos_adder_eur_per_kwh",
        "postsolve_battery_store_cost_eur_per_kwh",
        "postsolve_reported_4h_bess_capex_eur_per_kwh",
    ...
    "deployment_constraints.csv": [
        ...
        "penalty_basis",
        "cost_granularity",
        "basis_cost_eur_per_unit_min",
        "basis_cost_eur_per_unit_max",
        "basis_cost_eur_per_unit_mean",
        "basis_cost_eur_per_unit_median",
        "basis_cost_eur_per_unit_representative",
        "basis_cost_source",
        "learning_capital_cost",
        "learning_c_overnight",
        "basis_cost_heterogeneous",
        "asset_count",
        "persistent_shock",
        "annual_shock",
        ...
        "uncertainty_mode",
        "uncertainty_sigma_log",
        "uncertainty_multiplier",
        "uncertainty_truncate_multipliers",
        "uncertainty_seed_value",
        "battery_pipeline_base_energy_gwh",
        "battery_pipeline_base_power_gw",
        "battery_pipeline_target_energy_gwh",
        "battery_pipeline_target_charger_power_gw",
        "battery_pipeline_target_discharger_power_gw",
        "battery_pipeline_solved_energy_gwh",
        "battery_pipeline_solved_charger_power_gw",
        "battery_pipeline_solved_discharger_power_gw",
        "battery_pipeline_energy_slack_gwh",
        "battery_pipeline_charger_power_slack_gw",
        "battery_pipeline_discharger_power_slack_gw",
        "battery_pipeline_energy_binding",
        "battery_pipeline_charger_power_binding",
        "battery_pipeline_discharger_power_binding",
        "battery_pipeline_reference_duration_hours",
    ],
    "system_summary.csv": [
        "year",
        "objective_eur",
